---
name: sm
description: "FK Scrum Master Agent. Use for sprint management, ceremonies, and team facilitation. Activates the @sm persona from AIOS framework."
---
...
agent:
  ...
  memory_file: .claude/agent-memory/sm/MEMORY.md
  customization: null
