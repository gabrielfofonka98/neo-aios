...
commands:
  ...
  - "*create-neo-aios-agent - Create agent in NEO-AIOS format (simplified, PT-BR, strict scope)"
...
self_awareness:
  ...
  all_commands:
    creation:
      ...
      - command: "*create-neo-aios-agent"
        description: "Criar agent no formato NEO-AIOS (simplificado, PT-BR, scope enforcement)"
        params: "{name} --tier c-level|vp|director|manager|ic --archetype Builder|Guardian|Analyst|Creator"
