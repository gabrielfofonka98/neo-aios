...
1. **Story 1: {{Database Migration Story}}**
   ...
   - **Predicted Agents**: @dev, @data-engineer (database changes require expert SQL review)
   - **Quality Gates**:
...
- **CodeRabbit Validation**: All stories include pre-commit reviews
  - Database stories: @data-engineer validates schema compliance, service filters, RLS policies
...
- Quality Mitigation:
  - @data-engineer reviews schema changes for payment tables
